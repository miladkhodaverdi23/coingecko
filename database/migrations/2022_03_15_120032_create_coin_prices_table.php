...
class CreateCoinPricesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('coin_prices', function (Blueprint $table) {
            ...
            $table->unsignedFloat('high_24h',20,10)->nullable();
            $table->unsignedFloat('low_24h',20,10)->nullable();
            $table->unsignedFloat('price_change_24h',25,20)->nullable();
            $table->unsignedFloat('price_change_percentage_24h',10,6)->nullable();
            $table->unsignedFloat('market_cap_change_24h',35,5)->nullable();
            $table->unsignedFloat('market_cap_change_percentage_24h',10,5)->nullable();
            ...
            $table->unsignedFloat('ath1_change_percentage',15,10)->nullable();
